		...
		<div>
				...
				<thead>
					<tr> <!-- class="first_tr" -->
						...
						<th scope="col">패키지이름</th>
						<th scope="col">패키지가격</th> 
						<th scope="col">패키지일정</th>
						<th scope="col">항공사</th>
						<th scope="col">삭제</th>
					</tr>
				</thead>
				...
				<c:if test="${empty list }">
					<tr> 
						<td colspan="5" align="center">
							<div class="no_data">전체 게시물 목록이 없습니다.</div>
						</td>
					</tr>
				</c:if>			
				</tbody>
			...
			<div class="travel_paging">
				...
				<c:forEach begin="${paging.getStartBlock() }"
					...
					<c:if test="${i == paging.getPage() }">
						<a href="admin_travel_list.do?page=${i}" class="page-link">${i}</a>
					</c:if>
			...
			<div class="bbs-btn_w">
				<input type="button" value="패키지 등록" class="btn btn-outline-secondary" onclick="location.href='travel_insert.do'">
			</div>
