			...
			<c:if test="${!empty list }">
				<c:forEach items="${list}" var="dto">
					...
					<tr>
						...
						<td width="14%">${dto.service_date }</td>
						<td width="8%">
	...
	<div class="text-center">
		<ul class="pagination">
		    ...
		    <c:if test="${paging.getPage() > paging.getBlock() }">
		        <li class="page-item"><a  class="page-link" href="oneQuestion_search.do?page=1&field=${paging.field }&keyword=${paging.keyword }&startDate=${paging.startDate}&endDate=${paging.endDate}&reply=${paging.reply}&service_code=${paging.service_code}">처음으로</a></li>
		        <li class="page-item"><a  class="page-link" href="oneQuestion_search.do?page=${paging.getStartBlock() - 1 }&field=${paging.field }&keyword=${paging.keyword }&startDate=${paging.startDate}&endDate=${paging.endDate}&reply=${paging.reply}&service_code=${paging.service_code}">◀</a></li>
		    </c:if>
		   
		    <c:forEach begin="${paging.getStartBlock() }"
		          				end="${paging.getEndBlock() }" var="i">
		       <c:if test="${i == paging.getPage() }">
		           <li class="page-item"><a class="page-link" href="oneQuestion_search.do?page=${i }&field=${paging.field }&keyword=${paging.keyword }&startDate=${paging.startDate}&endDate=${paging.endDate}&reply=${paging.reply}&service_code=${paging.service_code}">${i }</a></li>
		       </c:if>
		    ...
		    <c:if test="${paging.getEndBlock() < paging.getAllPage() }">
		        <li class="page-item"><a class="page-link" href="oneQuestion_search.do?page=${paging.getEndBlock() + 1 }&field=${paging.field }&keyword=${paging.keyword }&startDate=${paging.startDate}&endDate=${paging.endDate}&reply=${paging.reply}&service_code=${paging.service_code}">▶</a></li>
		        <li class="page-item"><a class="page-link" href="oneQuestion_search.do?page=${paging.getAllPage() }&field=${paging.field }&keyword=${paging.keyword }&startDate=${paging.startDate}&endDate=${paging.endDate}&reply=${paging.reply}&service_code=${paging.service_code}">마지막으로</a></li>
		    </c:if>
		</ul>	    
	</div>
